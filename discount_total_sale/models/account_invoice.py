...
class AccountInvoiceInherit(models.Model):
    ...
    amount_undiscounted = fields.Monetary(string='Undiscounted Amout', store=True, readonly=True, compute='_compute_amount',
    ...
    def _compute_amount(self):
        ...
        self.amount_undiscounted = self.amount_untaxed + self.amount_discount
